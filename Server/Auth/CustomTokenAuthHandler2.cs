...
{
    public class CustomTokenAuthHandler2 : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        public CustomTokenAuthHandler2(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
